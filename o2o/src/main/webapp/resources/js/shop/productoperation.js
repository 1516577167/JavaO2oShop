				...
				.getJSON(
						...
						function(data) {
							if (data.success) {
								...
								var optionSelected = product.productCategory.produceCategoryId;
								// 生成前端的HTML商品类别列表，并默认选择编辑前的商品类别
								optionArr
										.map(function(item, index) {
											var isSelect = optionSelected === item.produceCategoryId ? 'selected'
													: '';
...
//				product.point = $('#point').val();
				...
				product.productCategory = {
					produceCategoryId : $('#category').find('option').not(
							function() {
